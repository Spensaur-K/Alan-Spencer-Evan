/*!
 * --------------------------------------------------------------------------------
 * Author: Spencer Killen & Alan Yong
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewLoader = __webpack_require__(4),
	    controllerLoader = __webpack_require__(26),
	...
	function navigate(path) {
		...
		if (typeof template === "function") {
			template = template(Object.assign(ctx, _items2.default));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sockets = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function create() {
	        ...
	        _sockets.socket.on("signup", function (auth) {
	                _loading2.default.off();
	                if (auth.status === "success") {
	                        (0, _navigate.navigate)("home", auth);
	                } else {
	        ...
	        (0, _jquery2.default)(".button.signup").click(function (e) {
	                _loading2.default.on();
	                _sockets.socket.emit("signup", {
	                        username: (0, _jquery2.default)("#username").val(),
	                        password: (0, _jquery2.default)("#password").val(),
	                        first: (0, _jquery2.default)("#first_name").val(),
	                        last: (0, _jquery2.default)("#last_name").val()
	                });
	        });
	};

	function destroy() {
	        _sockets.socket.off("login");
	}
